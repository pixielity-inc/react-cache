...
jest.mock("../../../src/metadata/utils/updating/updateMetadataTargetName");
jest.mock(
...
describe(targetName.name, () => {
  ...
  beforeAll(() => {
    ...
    (
      updateMetadataTargetName as jest.Mock<typeof updateMetadataTargetName>
  ...
  describe("having a non undefined propertyKey and an undefined parameterIndex", () => {
    ...
    describe("when called", () => {
      ...
      beforeAll(() => {
        ...
        result = targetName(nameFixture)(targetFixture, propertyKeyFixture);
      });
    ...
    describe("when called, and injectBase throws an Error", () => {
      ...
      beforeAll(() => {
        ...
        try {
          targetName(nameFixture)(targetFixture, propertyKeyFixture);
        } catch (error: unknown) {
          result = error;
        }
      });
  ...
  describe("having an undefined propertyKey and an non undefined parameterIndex", () => {
    ...
    describe("when called, and injectBase throws an Error", () => {
      ...
      beforeAll(() => {
        ...
        try {
          targetName(nameFixture)(targetFixture, undefined, paramIndexFixture);
        } catch (error: unknown) {
          result = error;
        }
      });
